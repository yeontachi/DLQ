...
def main(out_dir):
    ...
    # state_dict()은 모든 weight/buffer 텐서를 key-value 형태로 변환
    sd = m.state_dict()
    ...
    manifest = {
        ...
        "tensors": {} # 여기에 각 weight 메타데이터가 추가됨
    }
